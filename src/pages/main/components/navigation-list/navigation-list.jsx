...
export const NavigationList = () => (
  <div className='navigation-list'>
    ...
    <div className='navigation-list-right'>
      <button type='button' className='sort-button sort-button-active' data-test-id='button-menu-view-window'>
      ...
      <button type='button' className='sort-button' data-test-id='button-menu-view-list'>
